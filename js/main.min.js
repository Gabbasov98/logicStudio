...
function gsapAnimation() {
    ...
    function indexAnim() {
        ...
        let portfolioCards = Array.from(document.querySelectorAll('.portfolio-card:nth-child(2)~.portfolio-card'));
...
let num1 = document.querySelector("._num1")
let num2 = document.querySelector("._num2")
let num3 = document.querySelector("._num3")
...
if(num1){
    new countUp.CountUp(num1, +num1.getAttribute("data-val"),countUpOptions);
}
if(num2){
    new countUp.CountUp(num2, +num2.getAttribute("data-val"),countUpOptions);
}
if(num3){
    new countUp.CountUp(num3, +num3.getAttribute("data-val"),countUpOptions);
}
